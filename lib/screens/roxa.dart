...
class RoxaHome extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Exame para faixa Azul.'),
            ...
            Center(
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => RoxaPoomsae()),
                  );
                },
                child: Text('Poomsae'),
              ),
...
class RoxaPoomsae extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Taeguk 4 Jang'),
        automaticallyImplyLeading: false,
        centerTitle: true,
        leading: IconButton(
