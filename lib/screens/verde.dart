...
class VerdeHome extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Exame para faixa Roxa.'),
            ...
            Center(
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => VerdePoomsae()),
                  );
                },
                child: Text('Poomsae'),
              ),
...
class VerdePoomsae extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Taeguk 3 Jang'),
        automaticallyImplyLeading: false,
        centerTitle: true,
        leading: IconButton(
