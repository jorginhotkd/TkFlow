...
class PretaHome extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Exame para faixa Preta.'),
            ...
            Center(
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => PretaPoomsae()),
                  );
                },
                child: Text('Poomsae'),
              ),
...
class PretaPoomsae extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Taeguk 8 Jang'),
        automaticallyImplyLeading: false,
        centerTitle: true,
        leading: IconButton(
