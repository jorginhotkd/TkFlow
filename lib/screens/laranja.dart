...
class LaranjaHome extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Exame para faixa Verde.'),
            ...
            Center(
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => LaranjaPoomsae()),
                  );
                },
                child: Text('Poomsae'),
              ),
...
class LaranjaPoomsae extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Taeguk 2 Jang'),
        automaticallyImplyLeading: false,
        centerTitle: true,
        leading: IconButton(
