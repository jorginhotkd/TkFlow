...
class VermelhaHome extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Exame para faixa Vermelha e Preta.'),
            ...
            Center(
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => VermelhaPoomsae()),
                  );
                },
                child: Text('Poomsae'),
              ),
...
class VermelhaPoomsae extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Taeguk 7 Jang'),
        automaticallyImplyLeading: false,
        centerTitle: true,
        leading: IconButton(
